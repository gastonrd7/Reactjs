...
class ProductAddContainer extends Component {
  ...
  //ref={node => this.nameInput = node} referencio el nodo a una propiedad que en este caso
  //la llamo maneInput esta propiedad es de this, por tal motivo luego puedo acceder facilmente a ella,
  //y por ende al valor del formulario.
  async handleSubmit (event) {
    ...
    //para que redireccione a la raiz
    browserHistory.push('/');
  }
